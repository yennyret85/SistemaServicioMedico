                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/users/'.$user->id) }}">
                        ...
                        <div class="form-group{{ $errors->has('lastname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="lastname" type="text" class="form-control" name="lastname" value="{{ $user->lastname or old('lastname') }}">
                        ...
                        <div class="form-group{{ $errors->has('idcard') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="idcard" type="text" class="form-control" name="idcard" value="{{ $user->idcard or old('idcard') }}">
                        ...
                        <div class="form-group{{ $errors->has('sex') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <label>
                                    <input id="sex" type="radio" name="sex" value="f" @if( $user->sex=='f' or old('sex')=='f') checked @endif> Femenino
                                </label> <br>
                                <label>
                                    <input id="sex" type="radio" name="sex" value="m" @if( $user->sex=='m' or old('sex')=='m') checked @endif> Masculino
                                </label>
                        ...
                        <div class="form-group{{ $errors->has('birtdate') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="birtdate" type="date" class="form-control" name="birtdate" value="{{ $user->birtdate or old('birtdate') }}">
                        ...
                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="tel" class="form-control" name="phone" value="{{ $user->phone or old('phone') }}">
                        ...
                        <div class="form-group{{ $errors->has('cellphone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="cellphone" type="tel" class="form-control" name="cellphone" value="{{ $user->cellphone or old('cellphone') }}">
